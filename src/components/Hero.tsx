...
export default function Hero() {
  const { name, title, description, whatsappNumber, whatsappMessage, heroImage } =
    heroInfo;
  ...
  return (
    <section
      ...
      style={{ background: "var(--bg-hero)", color: "var(--text-hero)" }}
    >
      <div
      ...
      <div className="container mx-auto px-4 z-20 grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 text-center md:text-left">
          ...
          <div className="pt-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-lg transition-transform hover:scale-105 shadow-lg"
              style={{
        ...
        <div className="hidden md:block relative">
          ...
          <img
            ...
            className="relative rounded-2xl shadow-2xl object-cover w-full h-[500px] border-4"
